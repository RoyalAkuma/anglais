...
Triangle.prototype = new GenericObject();
Triangle.prototype.constructor = Triangle ;

/** 
* Create a unit triangle with normal sym to i
* @param name name of this instance
* @param shader WebGL shader
*/
function Triangle( name , shader )
{
...
* Overload Prepare
*/
Triangle.prototype.Prepare = function( gl )
{    
    // vertices
    var vertices = [ 
	[ 0, 0, 0 ],
...
* Overload draw
*/
Triangle.prototype.Draw = function( gl , scn )
{
